...
const UNIQUE_EXTRA_PARAGRAPHS: ExtraBuilder[] = [
  (c) =>
    `Служба «${BRAND}» работает в ${c.cityPrep} и принимает звонки круглосуточно — 24/7, без выходных. Мастер по ${c.serviceLower} выезжает в течение 30–60 минут — в центр, спальные районы и пригород. Диагностика бесплатна при выполнении работ, стоимость согласовывается до начала ремонта.`,
  (c) =>
